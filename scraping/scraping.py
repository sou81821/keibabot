...
def scraping_races():
	...
	years  = [str(i) for i in range(2011, 2016)]  # 1:札幌, 2:函館, 3:福島, 4:新潟, 5:東京, 6:中山, 7:中京, 8:京都, 9:阪神, 10:小倉
	...
	for year, place, time, day, race in itertools.product(years, places, times, days, races):
		url = root_url + year + place + time + day + race
		get_race(url)
		t.sleep(1)
